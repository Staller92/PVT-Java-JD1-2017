/**
 * Напишите запрос, делающий выборку из обеих таблиц полей, где велечина расходов больше 100.
...
select*from  expenses where receiver=3 order by value;
...
select expenses.num,paydate,value,name from  expenses,receivers where receiver=receivers.num and value>100 order by value