...
public class DaoImpl implements Dao {
    ...
    public static DaoImpl getDaoImpl(Properties properties) {
        if (daoImpl != null) {
            return daoImpl;
        } else daoImpl = new DaoImpl(properties);
        return daoImpl;
    }

    private DaoImpl() {
    }
    private DaoImpl(Properties properties) {
    ...
    public Receiver getReceiver(int num) {
        ...
        try {
            ...
            Connection connection = ConnectTo.mySQL(properties);
